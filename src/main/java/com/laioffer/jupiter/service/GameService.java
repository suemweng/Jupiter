...
public class GameService {
    // Define five static Strings in GameService class.
    private static final String TOKEN = "Bearer qo84077vw5fu8c7fzv9sxnyqpmzksz";
    private static final String CLIENT_ID = "nerosk1b214yffcvr4m54kcgzzs3ex";
    ...
    // Returns the top K streams based on game ID.
    ...
    // Returns the top K clips based on game ID.
    ...
    // Returns the top K videos based on game ID.
    ...
    // Map<String, List<Item>>: String -- ItemType
